/* * 
 *  $Id: get_media_descr.c 85 2005-01-28 18:07:33Z shawill $
 *  
...
// Returns the media description according to the required format
{
    ...
    DEBUG_PRINT_INFO("prepare to enumating medias")     /*just for debug,yanf*/
    res=enum_media(object,&matching_descr);
    DEBUG_PRINT_INFO("enumate  media ok!")
    ...
    {
        /*If there is no specific request ,describe every media in the SD (recursive=1)*/
    ...
    {
        /*DEBUG_PRINTF("&&&&&&&&&&&&--getting media entry for required media!--&&&&&&&&&&&&\n");*/ /*just for debug,yanf*/
        /*获得所请求的媒体项*/
