/* * 
 *  $Id: utils.h 348 2006-05-30 16:41:33Z shawill $
 *  
...
#define trace_point() 	do {printf("cz_tracepoint: %s,%d\n",__FILE__,__LINE__); } while(0)			//10728
#define trace_sleep() 	do {printf("cz_tracesleep: %s,%d\n",__FILE__,__LINE__); sleep(1);} while(0)  //10728
...
int parse_url(const char *url,char *server, size_t, unsigned short *port, char *file_name, size_t);
